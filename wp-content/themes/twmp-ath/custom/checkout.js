jQuery(function ($) {
	...
	const stage = checkoutBlock.querySelector('[data-payment-stage]')
	const proofForm = stage ? stage.querySelector('[data-payment-proof-form]') : null
	const fileInput = stage ? stage.querySelector('[data-payment-file]') : null
	const fileLabel = stage ? stage.querySelector('[data-payment-file-label]') : null
	const submitButton = stage ? stage.querySelector('[data-payment-submit]') : null
	const notice = stage ? stage.querySelector('[data-payment-notice]') : null
	const statusBadge = stage ? stage.querySelector('[data-payment-status-badge]') : null
	const statusTitle = stage ? stage.querySelector('[data-payment-status-title]') : null
	const statusText = stage ? stage.querySelector('[data-payment-status-text]') : null
	...
	$(proofForm).on('submit', function (event) {
