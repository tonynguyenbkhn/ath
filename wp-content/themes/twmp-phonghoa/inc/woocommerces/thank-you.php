...
add_filter('woocommerce_thankyou_order_received_text', function ($text, $order) {
    ...
    $message  = sprintf(
        __('Cảm ơn bạn %1$s đã đặt hàng tại Nam Linh Digital.', 'twmp-phonghoa'),
    ...
    $message .= sprintf(
        __('Vui lòng thanh toán số tiền %s cho nhân viên giao hàng khi nhận được hàng.', 'twmp-phonghoa'),
        $total
    );
