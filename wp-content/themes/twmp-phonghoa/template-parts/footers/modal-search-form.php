...
<div class="<?php echo esc_attr( $_class ); ?>" id="<?php echo esc_attr( $_id ); ?>" role="dialog" <?php echo esc_attr( $_custom_attributes ); ?>>
    <div class="modal__wrapper">
        ...
        <button class="modal__close-button <?php echo esc_attr( $_close_button_class ); ?>" data-close-modal="modal-search-form" aria-label="<?php esc_attr_e('Close a modal', 'twmp-phonghoa'); ?>">
            <?php echo twmp_get_svg_icon('close'); ?>
        </button>
    </div>
</div>