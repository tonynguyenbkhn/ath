            ...
            'general' => [
                ...
                'fields' => [
                    ...
                    'strict_query_detection' => [
                        'label' => __( 'Advanced query detection', 'fwp' ),
                        'notes' => 'Prevents FacetWP from auto-detecting the wrong archive query. Needs to be enabled in 99% of cases. Keep enabled if in doubt.',
                    ...
                    'enable_indexer' => [
                        ...
                        'html' => $this->get_setting_html( 'enable_indexer', 'toggle', [
                            'true_value' => 'yes',
                            'false_value' => 'no',
                            'message' => ( ! apply_filters( 'facetwp_indexer_is_enabled', true ) ) ? 'A <a href="https://facetwp.com/?p=161010" target="_blank">facetwp_indexer_is_enabled</a> hook is detected, disabling indexing.<br />When this hook is used, this setting is ignored.' : ''
                        ])
                    ]
                ]
            ],
...
<?php endif;
    ...
    function get_export_choices() {
        ...
        foreach ( $settings['facets_missing'] as $facet ) {
            $export['facet-' . $facet['name']] = 'Facet - ' . $facet['label'];
        }
    ...
    function get_svg() {
        ...
        $icons = [
            ...
            "ban" => [512, 512, 16, "M367.2 412.5L99.5 144.8C77.1 176.1 64 214.5 64 256c0 106 86 192 192 192c41.5 0 79.9-13.1 111.2-35.5zm45.3-45.3C434.9 335.9 448 297.5 448 256c0-106-86-192-192-192c-41.5 0-79.9 13.1-111.2 35.5L412.5 367.2zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"]
        ];
